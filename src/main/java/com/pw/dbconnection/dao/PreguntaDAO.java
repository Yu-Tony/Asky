...
public class PreguntaDAO {
   ...
   public static PreguntaModel idPregunta(int myid){
      ...
      public static List<PreguntaModel> buscarPreguntaPorUsuario(String aBuscar){
                   List<PreguntaModel> preguntas = new ArrayList<>();
        ...
        try 
        {
            ...
            CallableStatement statement = con.prepareCall("select * from pregunta where usuario = ?");
            statement.setString(1, aBuscar);
            ResultSet resultSet = statement.executeQuery();
       ...
       public static List<PreguntaModel> buscarPreguntaPorUsuarioUtil(String aBuscar, Boolean Cual){
                   List<PreguntaModel> preguntas = new ArrayList<>();
        ...
        try 
        {
            ...
            CallableStatement statement = con.prepareCall("select * from util_pregunta where usuario = ?");
            statement.setString(1, aBuscar);
            ResultSet resultSet = statement.executeQuery();
            ...
            while (resultSet.next()) {
                // Obtenemos el valor del result set en base al nombre de la
                // columna
                int idPreg = resultSet.getInt("pregunta");
                Boolean utilono = resultSet.getBoolean("util");
                if(utilono == Cual){
                CallableStatement newStatement = con.prepareCall("select * from Pregunta where id = ?");
                newStatement.setInt(1, idPreg);
                
                ResultSet myNewResult = newStatement.executeQuery();
                
                while(myNewResult.next()){
                
                    String contenido = myNewResult.getString("contenido");
                    int id = myNewResult.getInt("id");
                    String descripcion = myNewResult.getString("descripcion");
                    String imagenPregunta = myNewResult.getString("imagen");
                    String usuarioPregunta = myNewResult.getString("usuario");
                    System.out.println(usuarioPregunta);
                    int categoriaPreguntaID = myNewResult.getInt("categoria");
                    String categoriaPregunta = null;
                    Date fecha_Pregunta = myNewResult.getDate("fecha");
                    int fav=0;
                    int util=0;
                    int comentarios=0;
       ...
       public static List<PreguntaModel> buscarPreguntaPorUsuarioFav(String aBuscar){
                   List<PreguntaModel> preguntas = new ArrayList<>();
        ...
        try 
        {
            ...
            CallableStatement statement = con.prepareCall("select * from fav_pregunta where usuario = ?");
            statement.setString(1, aBuscar);
            ResultSet resultSet = statement.executeQuery();
            ...
            while (resultSet.next()) {
                ...
                // columna
                int idPreg = resultSet.getInt("pregunta");
                Boolean favval = resultSet.getBoolean("fav");
                if(favval == true){
                CallableStatement newStatement = con.prepareCall("select * from Pregunta where id = ?");
                newStatement.setInt(1, idPreg);
